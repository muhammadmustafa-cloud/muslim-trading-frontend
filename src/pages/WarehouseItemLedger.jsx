              ...
              <table className="w-full">
                <thead>
                  <tr className="bg-slate-200 text-slate-700 font-black text-[9px] uppercase tracking-widest border-b border-slate-300">
                    ...
                    <th colSpan="3" className="py-2 px-3 text-center border-r border-slate-300 bg-indigo-100/50 text-indigo-900">Debit (Stock Out)</th>
                  ...
                  {data.ledger.length === 0 ? (
                    ...
                    data.ledger.map((row) => (
                      <tr key={row._id} className="hover:bg-slate-50 transition-colors group text-xs">
                        ...
                        {/* Balance */}
                        <td className="py-3 px-2 text-center border-r border-slate-100 bg-amber-50/10 font-bold text-amber-800">
