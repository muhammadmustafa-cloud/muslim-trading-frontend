                    ...
                    <tr key={row._id} className="table-row-hover">
                      ...
                      <td className="table-cell">
                        <div className="flex items-center gap-1 flex-wrap">
                          ...
                          <button type="button" onClick={() => navigate(`/party-ledger/${row._id}?role=supplier`)} className="btn-ghost-primary flex items-center gap-1 text-indigo-600 hover:text-indigo-700 bg-indigo-50"><FaHistory className="w-3.5 h-3.5" /> Detail</button>
